  ...
  return (
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-top">
          ...
          <div className="footer-col">
            <div className="logo-wrapper" style={{ marginBottom: '1rem' }}>
              ...
              <span className="logo-text font-serif italic" style={{ color: 'white' }}>Smile</span>
            </div>
        ...
        {/* Bottom Bar */}
        <div style={{ paddingTop: '2rem', borderTop: '1px solid rgba(255, 255, 255, 0.3)', textAlign: 'center', fontSize: '0.875rem', color: 'rgba(255, 255, 255, 0.8)' }}>
